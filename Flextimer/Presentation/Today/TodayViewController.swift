...
class TodayViewController: BaseViewController, ReactorKit.View {
    ...
    func bind(reactor: TodayViewControllerReactor) {
        self.todayView.reactor = reactor.reactorForTodayView()
    }
